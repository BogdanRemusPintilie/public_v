-- Update functions to include shared dataset access, not only owned datasets

-- 1) Portfolio summary
CREATE OR REPLACE FUNCTION public.get_portfolio_summary(
  dataset_name_param text,
  min_loan_amount numeric DEFAULT NULL::numeric,
  max_loan_amount numeric DEFAULT NULL::numeric,
  min_interest_rate numeric DEFAULT NULL::numeric,
  max_interest_rate numeric DEFAULT NULL::numeric,
  min_remaining_term numeric DEFAULT NULL::numeric,
  max_remaining_term numeric DEFAULT NULL::numeric,
  min_pd numeric DEFAULT NULL::numeric,
  max_pd numeric DEFAULT NULL::numeric,
  min_lgd numeric DEFAULT NULL::numeric,
  max_lgd numeric DEFAULT NULL::numeric
)
RETURNS TABLE(
  total_value numeric,
